export const profile = {
  ...
  bio: "제 개발 경험은 '콘텐츠를 사용자에게 안정적으로 전달하는 과정'을 넓혀온 과정이었습니다. KARING.kr에서 웹 서비스의 트래픽과 성능을, 애니멀톡에서 모바일 앱·백엔드·인프라 운영 전체를, AutoQuant.AI에서 AI를 실제 서비스 로직에 연결하는 신뢰성 설계까지 경험했습니다. 아직 주니어지만 한 가지는 분명합니다 — 기능을 완성하는 것보다, 사용자가 불편함을 느끼기 전에 먼저 찾아 없애는 것이 제가 생각하는 개발입니다.",
  contact: {
